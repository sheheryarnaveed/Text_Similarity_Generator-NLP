...
parser.add_argument('-s', dest='targetscore', help="A target score that determines how much similarity you want between texts", default=0.5)
    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            if(similarity > float(args.targetscore)):
                print(index+2, " , ", similarity, " => " , deEmojify(row['Enquiry']))
    except:
